...
const LeagueCards: React.FC<LeagueCardsProps> = ({ league }) => {
  ...
  return (
    <div className='h-[511px] xl:w-[237px] lg:w-[280px] md:w-[237px] sm:w-[270px] w-[300px] shadow-xl dark:shadow-none bg-[#FFFFFF] dark:bg-[#3B3E47] cursor-pointer transition-transform duration-200 transform-gpu hover:shadow-2xl  '
